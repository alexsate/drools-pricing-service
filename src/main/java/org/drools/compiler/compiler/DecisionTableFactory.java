...
public class DecisionTableFactory {
	...
	public static List<String> loadWorkSheetsFromResource(Resource resource, DecisionTableConfiguration configuration) {
		return getDecisionTableProvider().loadWorkSheetsFromResource(resource, configuration);
	}
