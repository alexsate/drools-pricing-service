...
public class KnowledgeBuilderImpl implements KnowledgeBuilder {
    ...
    PackageDescr decisionTableToPackageDescr(Resource resource,
        ...
        if ( dtableConfiguration != null && !dtableConfiguration.getRuleTemplateConfigurations().isEmpty() ) {
            List<String> generatedDrls = null;//DecisionTableFactory.loadFromInputStreamWithTemplates( resource, dtableConfiguration );
        ...
        List<String> generatedDrls = DecisionTableFactory.loadWorkSheetsFromResource( resource, dtableConfiguration );
